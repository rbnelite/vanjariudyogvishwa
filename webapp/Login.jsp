...
<input name="emailtextfield" type="text"/>      
 ...
 <input type="submit" style="background-image:url(images/login3.png); height: inherit;" width="90px;" height="55px"/></td>
        </tr>
        <tr>
          <td height="22">&nbsp;</td>
          <td><span class="style7"><span class="style8"> 
            <input name="" type="checkbox" value=""/>
            <span class="style21"><span class="style8">Remember Me </span>&nbsp;</span><span class="style7"></span><span class="style16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Forgot your Password</span></span></span></td>
        </tr>
      </table>
               </form>
      </td>
    ...
    <tr>
      <td width="639" height="731"><form action="" method="post" name="form1" class="style1" id="form1">
        ...
        <p><img src="images/url (2).jpg" alt="network"   align="middle" width="433" height="381" />        </p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <table width="639" height="121" border="0">
          <tr>
            <td width="207" height="117"><p class="style75"><img src="images/HvFtYLj0Rz_.png"><span class="style74">Get the Latest</span></p>
            <p class="style77">Update with ur latest activity</p></td>
            <td width="217"><p><img src="images/HvFtYLj0Rz_ (2).png"><span class="style76">Connect and share</span></p>
            <p class="style77">Share the moments with us</p></td>
            <td width="201"><p><img src="images/p-817leDFDe.png"><span class="style76">Add photos</span></p>
...
<tr>
     ...
     <tr> 
     <td width="121"  align="left" class="style59">First Name</td>
     <td width="194"><input type="text" name="fname" id="fname"size="30"><div id="fnameError" class="red"colspan="2"/></td>
     </tr>
     
     <tr>
     <td align="left" ><span class="style34"><span class="style46">Middle Name</span></span> </td>
     <td ><input type="text" name="mname" id="mname"size="30"><div id="mnameError" class="red" colspan="2"/></td>
     </tr>
    
     <tr>
     <td align="left" class="style46">Last Name </td>
     <td><input type="text" name="lname" id="lname"size="30"><div id="lnameError" class="red"colspan="2"/></td>
     </tr>
     <tr>
     <td align="left" class="style46">Email Id</td>
     <td><input type="text" name="email_id" id="email_id" size="30"><div id="email_idError" class="red"colspan="2"/></td>
     </tr>
     
     <tr>
     <td align="left" class="style46">Contact No.</td>
     <td><input type="text" name="contact" id="contact" size="30"><div id="contactError" class="red"colspan="2"/></td>
     </tr>
     
     <tr>
     <td align="left" class="style46">Birth Date</td>
     ...
     <tr>
     <td align="left" class="style46" >Gender</td>
     ...
     <tr>
     <td align="left" class="style46">Password</td>
     <td><input type="password" name="pass1" id="pass1" size="30"><div id="pass1Error" class="red"colspan="2"/></td>
     </tr>
    
     <tr>
     <td align="left" class="style46" >Confirm Password</td>
     <td><input type="password" name="pass2" id="pass2" size="30"><div id="pass2Error" class="red" colspan="2"/></td>
     </tr>
     
     <tr>
     <td height="96">     </td>
     <td align="right">
    <input name="Register" type="submit"  id="submit" style="background-image: url(images/signup3.png); width:85px; height:30px;"/></td>  
        </tr>
     </table>
      </div>
</tr>
