...
function init() {
   ...
   document.getElementById("registration").onsubmit = validateForm;
...
function validateForm() 
{
   ...
   return (isNotEmpty("fname", "Please enter first name!")
         && isAlphabetic("fname", "Please enter letters only!")
        //&& isLengthMinMax("fname", "Name Should have maximum 15 characters!", 1, 15)
        && isNotEmpty("mname", "Please enter middle name!")
        && isAlphabetic("mname", "Please enter letters only!")
       // && isLengthMinMax("mname", "Middle Name Should have maximum 15 characters!", 1, 15)
        && isNotEmpty("lname", "Please enter last name!")
         && isAlphabetic("lname", "Please enter letters only!")
        //&& isLengthMinMax("lname", "Last Name Should have maximum 20 characters!!", 1, 20)
        && isValidEmail("email_id", "Enter a valid email!")
        && isNumeric("contact", "Please enter a valid mobile number!")
        && isLengthMinMax("contact", "Please enter a 10-digit mobile number!", 10, 10)
        && isSelected("bday", "Please select birth date!")
        && isSelected("bmonth", "Please select birth month!")
        && isSelected("byear", "Please select birth year!")
        && isChecked("gender", "Please check a gender!")
        && isLengthMinMax("pass1", "Password should be 6 t0 20 characters!", 6, 20)
        && verifyPassword("pass1", "pass2", " OH! Password Does not match!")
 ...
 function validateForm1()
 {
   ...
   return (isSelected("country", "Please select your country!")
          && isNotEmpty("city", "Please enter your city!")
          && isNotEmpty("zodiac", "Please select your zodiac!")
       // && isNumeric("zipcode", "Please enter a 5-digit zip code!")
        //&& isLengthMinMax("zipcode", "Please enter a 5-digit zip code!", 5, 5)
        //&& isSelected("country", "Please make a selection!")
        // && isChecked("color", "Please check a color!")
 ...
 function Contact()
 {
   ...
   return (
   isNotEmpty("home_ad", "Please enter your Home Address!")
          && isNotEmpty("zodiac", "Please select your zodiac!")
       // && isNumeric("zipcode", "Please enter a 5-digit zip code!")
        //&& isLengthMinMax("zipcode", "Please enter a 5-digit zip code!", 5, 5)
        //&& isSelected("country", "Please make a selection!")
