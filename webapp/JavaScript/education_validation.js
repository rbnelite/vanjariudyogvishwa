...
function init() {
   ...
   document.getElementById("education").onsubmit = validateForm;
...
function validateForm() {
   return (isNotEmpty("school_name", "Please enter your school name!")
            && isAlphabetic("school_name", "enter letters only!")
            && isNotEmpty("clg_name", "Please enter your collage name!")
         && isAlphabetic("clg_name", "enter letters only!")
        && isSelected("graduation", "please select your graduation degree!")
        && isNotEmpty("pg_clg", "Please enter PG collage name!")
        && isAlphabetic("pg_clg", "enter charectors  only!")
        && isSelected("pg_degree", "Please select your post graduation!"));
