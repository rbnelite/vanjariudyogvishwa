...
function init() {
   ...
   document.getElementById("religion").onsubmit = validateForm;
    
    // Attach "onclick" handler to "reset" button
   document.getElementById("reset").onclick = clearDisplay;
   // Set initial focus
   document.getElementById("religion11").focus();
}
...
function validateForm() 
{
   ...
   return (isSelected("religion11", "Please select religion!")
        && isNotEmpty("cast", "Please enter your cast!")
        && isAlphabetic("cast", "Please enter only letters!")
        && isLengthMinMax("cast", "Please enter maximum 20 characters!!", 1,20)
        && isNotEmpty("mother", "Please enter your mothertoung!")
        && isAlphabetic("mother", "Please enter only letters!")
        && isLengthMinMax("mother", "Please enter maximum 15 characters!!", 1,15)
        && isAlphabetic("natplace", "Enter your native place!")
        && isLengthMinMax("natplace", "Please enter maximum 15 characters!!", 1,15));
}
