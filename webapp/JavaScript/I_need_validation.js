...
function init() {
   ...
   document.getElementById("I_nedd").onsubmit = validateForm;
   // Attach "onclick" handler to "reset" button
   //document.getElementById("reset").onclick = clearDisplay;
   // Set initial focus
   document.getElementById("need_what").focus();
}
...
function validateForm() {
   return (isAlphabetic("need_what", "Please enter your need!")
             
        && isAlphabetic("need_desc","Please enter description your need!")
        //&& isLengthMinMax("city", "Enter max 15 characters!", 1, 15)
        //&& isSelected("zodiac", "Please select your zodiac!"))
        //&& isAlphabetic("zodiac","Please use only alphabets !")
        //&& isLengthMinMax("zodiac", "Enter max 15 characters!", 1, 15));
         && isNumeric("mobile", "Please enter mobile number!")
         && isLengthMinMax("mobile", "Please enter a 10 to 12-digit mobile number!", 10, 12))
        //&& isSelected("country", "Please make a selection!")
        //&& isChecked("gender", "Please check a gender!")
       // && isChecked("color", "Please check a color!")
        //&& isNumeric("phone", "Please enter a 10 Digit phone number!")
