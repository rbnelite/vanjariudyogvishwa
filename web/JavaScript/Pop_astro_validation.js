...
function init() {
   ...
   document.getElementById("Pop_astro").onsubmit = validateForm;
   // Attach "onclick" handler to "reset" button
   //document.getElementById("reset").onclick = clearDisplay;
   // Set initial focus
   document.getElementById("a_country").focus();
}
...
function validateForm() {
   return (isAlphabetic("a_country", "Please use only alphabets!")
        //&& isNotEmpty("country", "Please enter your name!")
        //&& isNotEmpty("city", "Please enter your city!")
        && isAlphabetic("a_city","Please use only alphabets !")
        //&& isLengthMinMax("city", "Enter max 15 characters!", 1, 15)
        && isAlphabetic("a_zodiac", "Please use only alphabets!"))
