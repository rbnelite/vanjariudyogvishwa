...
function init() {
   ...
   document.getElementById("family").onsubmit = validateForm;
   // Attach "onclick" handler to "reset" button
   document.getElementById("reset").onclick = clearDisplay;
   // Set initial focus
   document.getElementById("fmly_value").focus();
...
function validateForm() {
   return (isNotEmpty("fmly_value", "Please enter no of family number!")
        && isNumeric("fmly_value", "Please enter Number !")
        && isLengthMinMax("fmly_value", "Please enter  1 to 2 digit!", 1, 2)
        && isSelected("fmly_type", "Please select family type!")
        && isSelected("fmly_status", "Please select family status!")
        && isSelected("fmly_income", "Please select family income!"));
