...
function init() {
   ...
   document.getElementById("occupationform").onsubmit = validateForm;
...
function validateForm() {
   return (isNotEmpty("org_name", "Please enter organization!")
        && isAlphabetic("org_name","Please enter only character!")
        && isSelected("occupation", "Please select your occupation!")
        && isNotEmpty("product_details", "Please enter product details!", 5, 5)
        && isNumeric("total_emp", "Please enter no of employe!")
        && isSelected("emp_type", "Please select your emplyee type!")
        //&& isNotEmpty("emp_type", "please enter employment type!")
        //&& isAlphabetic("emp_type","Please enter only character!")
        && isNumeric("annual_income", "Please enter annuel income!"));
