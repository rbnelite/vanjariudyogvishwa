...
function init() {
   ...
   document.getElementById("lifestyle").onsubmit = validateForm;
...
function validateForm() {
   return (isSelected("diet", "Please select your diet!")
        && isSelected("smoke", "are u smoking or not!")
        && isSelected("drink", "are u drinking or not!")
        && isSelected("complexion", "Please select body complexion!")
         //&& isLengthMinMax("complexion", "Enter max 10 characters!", 1, 10)
        && isSelected("bd_type", "Please select your body type!")
        //&& isLengthMinMax("bd_type", "Enter max 10 characters!", 1, 10)
        && isSelected("bld_group", "Please select your blood group!")
        && isNotEmpty("weight", "Please enter your weight!")
        && isNumeric("weight", "Enter digits only!")
        && isLengthMinMax("weight", "Enter max 2 or 3 characters!", 2, 3)
        //&& isNotEmpty("lang", "Enter your known languages!")
       );
}
