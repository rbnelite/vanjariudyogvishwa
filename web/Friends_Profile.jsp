...
<%@page import="COM.RBNELITE.ENTITY.FriendshipDao"%>
<%@page import="COM.RBNELITE.ENTITY.OtherDao"%>
<%@page import="COM.RBNELITE.ENTITY.HobbiesDao"%>
<%@page import="COM.RBNELITE.ENTITY.LifestyleDao"%>
<%@page import="COM.RBNELITE.ENTITY.ReligionDao"%>
<%@page import="COM.RBNELITE.ENTITY.FamilyDao"%>
<%@page import="COM.RBNELITE.ENTITY.AstroDao"%>
<%@page import="COM.RBNELITE.ENTITY.ContactDao"%>
<%@page import="COM.RBNELITE.ENTITY.EducationDao"%>
<%@page import="COM.RBNELITE.BUSINESSPORTAL.SERVICE.GroupSer"%>
...
<%@page import="COM.RBNELITE.BUSINESSPORTAL.SERVICE.ProfileSer"%>
...
function validate()
{
    ...
    <body >
            <%
           String user_mail=(String)session.getAttribute("mail");
            //String user_mail="anil@gmail.com";
            %>
            <div id="main">
 ...
 %>
        ...
        <div id="leftSide">
            <div id="profile_header">
                <table align="center" width="100%"><tr><td><a href="Home.jsp" style="text-decoration: none" ><b>Home</b> </a></td>
                        <td><a href="Profile.jsp?iPagNo=1" style="text-decoration: none"><b>Profile</b></a> </td>
                        <td><a href="#" style="text-decoration: none"><b>Network</b></a> </td>
                        <td><a href="#" style="text-decoration:none" onclick="ShowINeedPage();"><b>I Need</b></a></td>
                        <td><a href="Message.jsp" style="text-decoration: none"><b>Messages</b></a></td>
                        <td><a href="Events.jsp" style="text-decoration: none"><b>Events</b></a></td>
                        <td>
         
           <a href="Friend_request.jsp" style="text-decoration: none" onclick="return hs.htmlExpand(this, { objectType: 'ajax'} )"><font color="white"size="3"> Request</font><font color="red" size="4"></font></a>
                 
                        </td>
            <td><a href="index.jsp" style="text-decoration: none"><b>LogOut</b></a> </td>
            </tr></table>
            </div>
            <div id="GroupDetails">
           ...
           String gp[]= new String[1];
            int s;
             ...
             <td width="100%"><h4><a href="#" style="text-decoration: none"><%=gp[0]%> </a></h4></td>
              ...
              %>
              <tr><td>
               <a href="Profile.jsp?iPagNo=<%=pageNo+1%>" onclick="<%%>"></a>
               </td></tr>
                </table>
               </div>
            </div>
...
<table align="center">
     <tr>
         <td><img src="icons/EDUCATION.png" width="50" height="50"> </td><td><font style="font-family: cursive"><b>Education</b></font></td>
   ...
   %>
          <table align="center"><tr><td><img src="icons/contact_details.png" width="50" height="50"> </td><td><font style="font-family: cursive"><b>Contact Details</b></font></td></tr></table>
           <table style="margin-left: 150px;">
                ...
                <tr><td>Official Address</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><%=contact[0]%></td> </tr>
             
                <tr><td>Telephone</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><%=contact[1]%></td>
                   
                <tr><td>Home Address</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><%=contact[3]%></td></tr>
               
                <tr><td>Residential Status</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><%=contact[2]%></td></tr>
                <tr><td>Mobile</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>from registration table</td></tr>
           ...
           <table style="margin-left: 150px;">
               <tr><td>Family Values</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><%=famly[0]%></td></tr>
      ...
      %>
           ...
           <tr> <td>Faverate Moviues </td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><%=hobb[6]%></td>  </tr> 
           <tr>  <td> Sports </td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><%=hobb[7]%></td> </tr> 
           <tr>  <td> Food </td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><%=hobb[8]%></td> </tr> 
           <tr>  <td>Faverite Vacation Place</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><%=hobb[9]%></td> </tr> 
          </table>
...
count=0;    
   ...
   %>
        ...
        Query queryResult21 = s21.createQuery("from StatusUpdateDao where user_email='"+userName+"' order by status_date desc"); 
