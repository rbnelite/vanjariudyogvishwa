...
import COM.RBNELITE.ENTITY.Intrest_areasDao;
    ...
    public List getResult(String user_mail,String pageNumber)
    {
         ...
         int pNumber=Integer.parseInt(pageNumber);
              ArrayList list = new ArrayList();
               SessionFactory sf9 =  new Configuration().configure().buildSessionFactory(); 
               Session s9=sf9.openSession();
               s9.beginTransaction();  
               List allUsers9;  
               Query queryResult9 = s9.createQuery("from Intrest_areasDao where user_mail='"+user_mail+"'");
   ...
   public String GroupImages(String group_name)
   {
       String imgpath="";
        SessionFactory sf9 =  new Configuration().configure().buildSessionFactory(); 
               ...
               s9.beginTransaction();  
               List allUsers9;  
               SQLQuery queryResult9 = s9.createSQLQuery("SELECT grp_image_path FROM tbl_group_image WHERE grp_name='"+group_name+"'");
